...
def create_model(input_shape: tuple, hidden_layers: tuple, hl_activations: List, output_layer: int, output_activation: str, optimizer: str, lr: float) -> tf.keras.Sequential:
